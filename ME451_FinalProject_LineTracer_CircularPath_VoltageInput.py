...
# 3) Initial condition
Xd = np.array([[0, r_traj, -np.pi, 0, 0]]).T 			# Desired state vector. Currently contains X0_d only
X = np.array([[-0.3, r_traj-0.2, -np.pi/2, 0, 0]]).T 	# Actual state vector. Currently contains X0 only
